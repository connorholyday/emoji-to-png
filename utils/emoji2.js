...
(function() {
  ...
  var emoji = function() {
    ...
    self.img_sets = {
      apple: {
        path: '/emoji-data/img-apple-160/',
        sheet: '/emoji-data/sheet_apple_64.png',
        sheet_size: 64,
        mask: 1,
      },
      google: {
        path: '/emoji-data/img-google-160/',
        sheet: '/emoji-data/sheet_google_64.png',
        sheet_size: 64,
        mask: 2,
      },
      twitter: {
        path: '/emoji-data/img-twitter-160/',
        sheet: '/emoji-data/sheet_twitter_64.png',
        sheet_size: 64,
        mask: 4,
      },
      emojione: {
        path: '/emoji-data/img-emojione-160/',
        sheet: '/emoji-data/sheet_emojione_64.png',
        sheet_size: 64,
        mask: 8,
      },
      facebook: {
        path: '/emoji-data/img-facebook-160/',
        sheet: '/emoji-data/sheet_facebook_64.png',
        sheet_size: 64,
        mask: 16,
      },
      messenger: {
        path: '/emoji-data/img-messenger-160/',
  ...
  emoji.prototype.replace_emoticons_with_colons = function(str) {
    ...
    var str_replaced = str.replace(self.rx_emoticons, function(
      m,
      $1,
      emoticon,
      offset
    ...
    if (emoticons_with_parens.length) {
      ...
      str_replaced = str_replaced.replace(parenthetical_rx, function(
        m,
        $1,
        emoticon,
        $2
    ...
    return str.replace(self.rx_colons, function(m) {
      ...
      if (idx.indexOf('::skin-tone-') > -1) {
        ...
        if (val) {
          ...
          return self.replacement(skin_val, skin_idx, ':');
        }
      } else {
        var val = self.map.colons[idx];
